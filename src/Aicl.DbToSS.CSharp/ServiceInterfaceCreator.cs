...
namespace Aicl.DbToSS.CSharp
{
	public class ServiceInterfaceCreator{
		...
		public virtual void Write()
		{
			...
			using (TextWriter twp = new StreamWriter(Path.Combine(interfaceDir, "AuthenticationProvider.cs")))
			{
				twp.Write(string.Format(authenticationProviderTemplate,SolutionName,ServiceNameSpace));				
				twp.Close();
			}
...
{{
	...
	{{
		...
		private string authenticationProviderTemplate=@"using System;
using System.Globalization;
using System.Collections.Generic;
using ServiceStack.Common;
using ServiceStack.Common.Web;
